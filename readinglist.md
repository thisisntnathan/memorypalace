...
Dariusz Szczepanik, Pawel Wieczorkiewicz  
*Theoretical and Computational Chemistry on ChemRxiv*  
2025-07-30  
&ensp;The paper presents a wavefunction-based framework for analyzing electron density in c0-conjugated systems to reveal chemical resonance patterns. It challenges existing views by suggesting that aromaticity derives from electron coherence rather than magnetic current. The method was applied to various c0-systems, enhancing the understanding of resonance beyond conventional indicators.  
- [Semantically-Linked Ontological Knowledge Extraction Graph For Domain-Specific Knowledge Discovery In Scientific Literature](https://dx.doi.org/10.26434/chemrxiv-2025-4pk4w?rft_dat=source%3Ddrss)  
Sana Kashgouli, Ali Malek, Shayan Mousavi M., Shahlla Naseri, Kogie Esteban, Robert Black, Michael Freund, Mita Dasog, Khalid Fatih  
*Theoretical and Computational Chemistry on ChemRxiv*  
2025-07-30  
&ensp;The paper presents the semantically-linked ontological knowledge extraction graph (SOKE Graph) to tackle challenges in scientific literature retrieval. It utilizes large-language models for extracting domain-specific concepts organized in an ontology. Initial evaluations indicate SOKE Graph improves accuracy in filtering relevant papers and generates structured outputs for efficient literature analysis and decision-making.  
- [Strong field quantum control of bimolecular reactions](https://dx.doi.org/10.26434/chemrxiv-2025-stbjv-v3?rft_dat=source%3Ddrss)  
Jyotirmoy Ray, Tamar Seideman  
*Theoretical and Computational Chemistry on ChemRxiv*  
2025-07-30  
&ensp;The paper discusses a strategy for quantum control in polyatomic bimolecular reactions using moderate-intensity, long pulse laser fields. It leverages a nonresonant, polarized field with a polarizability tensor for spatially nonuniform Stark shifts. Results based on quantum mechanics and ab-initio calculations enhance reaction control, illustrated through the CH + N2 reaction model.  
- [A Fragment Based Approach Towards Curating, Comparing and Developing Machine Learning Models Applied in Photochemistry](https://dx.doi.org/10.26434/chemrxiv-2025-l6pb4-v2?rft_dat=source%3Ddrss)  
...
*Theoretical and Computational Chemistry on ChemRxiv*  
2025-07-30  
&ensp;This paper presents a fragment-based strategy to enhance machine learning models predicting molecular properties in photochemistry, addressing exciton localization issues. Utilizing a new dataset, ALFAST-DB, with 46,432 energy gaps, the authors compare its diversity against existing datasets and show that their approach improves generalizability and accuracy, matching traditional message passing graph neural networks' performance.  
- [High-Performance, High-Angular-Momentum J Engine on Graphics Processing Units](https://dx.doi.org/10.26434/chemrxiv-2025-2lntb-v2?rft_dat=source%3Ddrss)  
Giuseppe Maria Junior Barca, Elise Palethorpe  
*Theoretical and Computational Chemistry on ChemRxiv*  
2025-07-30  
&ensp;The paper presents a high-performance J engine for evaluating electron repulsion integrals (ERIs) with high-angular-momentum Gaussian basis functions on GPUs. The method optimizes the McMurchie-Davidson algorithm with an integral batching scheme, resulting in speedups of up to 9x for individual kernels and a 64% improvement in J-matrix formation across datasets like polyglycine chains and water clusters.  
- [Sampling High-Dimensional Conformational Free Energy Landscapes of Active Pharmaceutical Ingredients](https://dx.doi.org/10.26434/chemrxiv-2025-j2n83-v2?rft_dat=source%3Ddrss)  
Matteo Salvalaglio, Alexandre Ferreira, Rui Guo, Ivan Marziano  
*Theoretical and Computational Chemistry on ChemRxiv*  
2025-07-30  
&ensp;The paper presents a gridless framework for computing high-dimensional conformational free energy surfaces (FES) using enhanced sampling trajectories. It employs concurrent well-tempered metadynamics and Density Peaks Advanced clustering for analysis. Validation includes alanine dipeptide and the solvent-dependent conformations of bicalutamide, showing accuracy against NMR and crystallographic data. This method aids in drug design and polymorphism analysis.  
- [SLICE (SMARTS and Logic In ChEmistry): Fast generation of molecules using advanced chemical synthesis logic and modern coding style](https://dx.doi.org/10.26434/chemrxiv-2025-m6klm?rft_dat=source%3Ddrss)  
Nadya Tarasova, Stefi Nouleho Ilemo, Victorien Delanné, Olga Grushin, Philip Judson, Hitesh Patel, Marc Nicklaus  
*Theoretical and Computational Chemistry on ChemRxiv*  
2025-07-30  
&ensp;The paper introduces SLICE (SMARTS and Logic In ChEmistry), a tool enabling rapid generation of virtual compound libraries from vast chemical databases. Utilizing a no-code graphical interface, SLICE allows chemists to define customized chemistries, generating 0.6 to 2.5 million compounds per hour, enhancing efficiency in drug lead discovery.

## 30 Jul 2025  

- [Introducing Quantitative Assessment of Michaelis Constant (Km) Accuracy](https://dx.doi.org/10.26434/chemrxiv-2025-tkrnx?rft_dat=source%3Ddrss)  
Sergey Krylov, Tong Wang, Parmeetpal Dhillon, Svetlana Krylova, Amit Bijlani, Sebastian Schreiber, Dasantila Golemi-Kotra, Joachim Jose  
*Biological and Medicinal Chemistry on ChemRxiv*  
2025-07-29  
&ensp;The paper introduces the Accuracy Confidence Interval (ACI) framework for assessing the accuracy of Michaelis constant (Km) values in enzyme kinetics. Using a binding-isotherm regression approach, the method incorporates concentration uncertainties and avoids traditional limitations. Results demonstrate that conventional software underestimates Km uncertainty, while ACI offers reliable bounds. A web application is provided for automated analysis.  
- [Glide WS: Methodology and Initial Assessment of Performance for Docking Accuracy and Virtual Screening](https://dx.doi.org/10.26434/chemrxiv-2025-0s90h?rft_dat=source%3Ddrss)  
Steven Jerome, Richard Friesner, Yuqi Zhang, Robert Murphy, Pierre Devlaminck, Ivan Tubert-Brohman, Yeyue Xiong  
*Biological and Medicinal Chemistry on ChemRxiv*  
2025-07-29  
&ensp;The paper presents Glide WS, a virtual screening method that incorporates water structure in docking accuracy, achieving 92% self-docking accuracy using 1477 protein-ligand complexes, compared to 85% for Glide SP. It improves virtual screening enrichment with 38 targets and reduces poorly scoring decoys, suggesting higher hit rates in practical applications. The method is tuned with Absolute Binding Free Energy Perturbation calculations.  
- [Towards enhanced selection of antibiotics in a hospital laboratory 33 development of a rapid electrochemical-based antimicrobial sensitivity test for Urinary Tract Infections](https://dx.doi.org/10.26434/chemrxiv-2025-r6p2m?rft_dat=source%3Ddrss)  
Adrian Butterworth, Heather Ralston, Ben Clark, Maria Katsafadou, Vincent Vezza, Tyla Campbell, Michael Malecha, Michael Murphy, Aruna Poojary, Amanda Winter, David Price, Emma Marrs, Alistair Longmuir, Stuart Hannah, Paul Hoskisson, Damion Corrigan  
*Biological and Medicinal Chemistry on ChemRxiv*  
2025-07-29  
&ensp;The paper presents the Microplate Dx RapidPlate™ platform, an electrochemical impedance spectroscopy (EIS) method for rapid antibiotic susceptibility testing (AST) of urinary tract infections (UTIs) using 89 clinical urine samples. The system achieved bacterial growth detection in 50 minutes and provided susceptibility profiles in 85 minutes, demonstrating 94% concordance with traditional methods, showing promise for improved UTI management and antimicrobial stewardship.  
- [Quantitative exposomics targeting over 200 toxicants and key biomarkers at picomolar concentrations](https://dx.doi.org/10.26434/chemrxiv-2025-sb0nl-v3?rft_dat=source%3Ddrss)  
Yunyun Gu, Max Lennart Feuerstein, Caroline Helen Johnson, Benedikt Warth, Dillon T Lloyd, Chirag J Patel  
*Biological and Medicinal Chemistry on ChemRxiv*  
2025-07-29  
&ensp;The paper presents a scalable workflow for analyzing over 230 biomarkers in urine, plasma, and serum at picomolar concentrations using targeted LC-MS/MS. The method showed robust performance, detecting over 140 analytes in a study of 200 urine samples from pregnant women. Its high sensitivity and broad analyte coverage support its use in large-scale exposome-wide association studies (ExWAS).  
- [Cryo-EM exposes diverse polymorphism in IAPP mutants to guide the rational design of peptide-based therapeutics](https://dx.doi.org/10.26434/chemrxiv-2025-0bdpp-v2?rft_dat=source%3Ddrss)  
...
*Biological and Medicinal Chemistry on ChemRxiv*  
2025-07-29  
&ensp;The paper investigates non-amyloidogenic variants of human Islet Amyloid Polypeptide (hIAPP) through cryo-electron microscopy, focusing on single-point mutations A25P, S28P, and S29P. It identifies six polymorphs and a unique trimeric aggregate in A25P. The study offers structural insights to design new therapeutic IAPP mutants for type 2 diabetes.

## 29 Jul 2025  

- [ChainSpace: Sequence-Aware Design for Machine Learning-Driven Polymer Engineering](https://dx.doi.org/10.26434/chemrxiv-2025-cs3gj?rft_dat=source%3Ddrss)  
Jeffrey, Ting; Gustavo, Guzman; Shashi, Murthy; Thomas, Neenan; Sean, Kevlahan  
*Biological and Medicinal Chemistry on ChemRxiv*  
2025-07-28  
&ensp;The paper introduces ChainSpace, a computational framework for polymer engineering that emphasizes sequence-aware design. It maps synthetically accessible sequence space using compositional, kinetic, temporal, and spatial controls. The study identifies an optimal sequence for gene delivery polymers, achieving 85% transfection efficiency, highlighting the importance of sequence statistics in polymer design.  

- [Leveraging a Large-Scale Experimental Database of Ruthenium Complexes to Predict Cytotoxicity for Anticancer Purposes Using Machine Learning](https://dx.doi.org/10.26434/chemrxiv-2025-1nqvm?rft_dat=source%3Ddrss)  
Lev, Krasnov; Dmitry, Malikov; Marina, Kiseleva; Ekaterina, Nykhrikova; Sergei, Tatarin; Stanislav, Bezzubov  
*Biological and Medicinal Chemistry on ChemRxiv*  
2025-07-28  
&ensp;The paper presents a machine learning approach for predicting the cytotoxicity of ruthenium complexes using a dataset of 12,439 cytotoxicity values from 3,247 complexes. The method achieved a ROC-AUC of 0.76 in binary classification and significantly increased the hit rate in drug exploration. A digital tool for high-throughput screening was also developed.  

- [Harnessing Graph Learning for Surfactant Chemistry: PharmHGT, GCN, and GAT in LogCMC Prediction](https://dx.doi.org/10.26434/chemrxiv-2025-88hhb?rft_dat=source%3Ddrss)  
Gabriela, Theis Marchan; Toheeb O., Balogun; Kyle, Territo; Teslim, Olayiwola; Revati, Kumar; Jose A, Romagnoli  
*Organic Chemistry on ChemRxiv*  
2025-07-28  
&ensp;The paper evaluates graph-based machine learning models, including PharmHGT, GCNs, and GATs, for predicting LogCMC values of surfactants. It integrates molecular dynamics simulations to enhance predictions and developed a surfactant detection module that classifies surfactants based on functional groups. Results indicate that transformer models like PharmHGT outperform traditional approaches, improving the accuracy of CMC predictions for various applications.  

- [Engineering artificial metabolic pathways within live mammalian cells through the integration of enzymes and transition metal catalysts](https://dx.doi.org/10.26434/chemrxiv-2025-j7ttt-v2?rft_dat=source%3Ddrss)  
Jose Luis, Mascares; Alejandra , Vale-G mez; Alejandro , Guti rrez-Gonz alez; Leonard, Cool; Cristian, Vidal; Mar a, Tom as-Gamasa  
*Organic Chemistry on ChemRxiv*  
2025-07-28  
&ensp;The paper discusses engineering artificial metabolic pathways in live mammalian cells by integrating exogenous transition metal catalysts with natural enzymes. This method enables designed non-natural reactions, producing fluorescent or bioactive products from exogenous substrates specifically in cells that utilize both catalytic systems.  

- [Probing the Adsorption of Fibronectin onto Model Biomaterial Surfaces using Molecular Dynamics Simulations](https://dx.doi.org/10.26434/chemrxiv-2025-w3x3w?rft_dat=source%3Ddrss)  
David, Cheung; Viswanath, Vittaladevaram  
*Theoretical and Computational Chemistry on ChemRxiv*  
2025-07-28  
&ensp;The paper investigates fibronectin adsorption on biomaterial surfaces using molecular dynamics simulations of type-III fibronectin fragments. It finds stronger adsorption on hydrophobic surfaces (ethyl acrylate) than hydrophilic ones (methyl acrylate), highlighting how minor surface chemistry changes significantly impact protein behavior. This insight could enhance biomaterial design for improved protein interactions.  

- [Relating model performance to embedding distributions in molecular machine learning](https://dx.doi.org/10.26434/chemrxiv-2025-qmqdr?rft_dat=source%3Ddrss)  
Johannes, Kirchmair; Ellena, Jiang; Ioannis, Papantonis; Matthias, Welsch  
*Theoretical and Computational Chemistry on ChemRxiv*  
2025-07-28  
&ensp;The paper examines the relationship between model performance and embedding distributions in molecular machine learning using representational alignment. It introduces a framework predicting an exclusion zone where high alignment prevents large performance gaps, validated across multiple datasets. The study shows little difference in alignment between ensembles and individual models, offering insights for enhancing molecular machine learning systems.  

- [CASCADE-20: Real Time Prediction of 13C-NMR Shifts with sub-ppm Accuracy](https://dx.doi.org/10.26434/chemrxiv-2025-r8m9m?rft_dat=source%3Ddrss)  
Mihai, Popescu; Robert, Paton; Abhijeet, Bhadauria; Zhitao, Feng  
*Theoretical and Computational Chemistry on ChemRxiv*  
2025-07-28  
&ensp;The paper presents CASCADE-2.0, a deep learning model for predicting 13C-NMR shifts with sub-ppm accuracy. It uses an expanded dataset of 211,000 experimental values, enhanced by intelligent data augmentation. The model achieves accuracy of 0.73 ppm, includes prediction confidence metrics, and features a user-friendly web-server for applications in chemical structural assignments.  

- [Molecular Insights into Zymomonas mobilis Membrane Interactions with Lignocellulosic Inhibitors](https://dx.doi.org/10.26434/chemrxiv-2025-039zg?rft_dat=source%3Ddrss)  
Josh, Vermaas; Nitin Kumar, Singh  
*Theoretical and Computational Chemistry on ChemRxiv*  
2025-07-28  
&ensp;The paper investigates Zymomonas mobilis membrane interactions with lignocellulosic inhibitors using all-atom molecular dynamics simulations. It analyzes how small molecules affect membrane properties across concentrations (0–2.5 mol%). Results indicate that higher concentrations thin the membrane and increase permeability, notably for hydrophobic compounds. Hopanoids stabilize membranes but are insufficient against larger molecules. This knowledge aids future biofuel strain engineering efforts.  

- [All-Atom Reactive Monte Carlo Molecular Dynamics for Molecular Doping in Organic Semiconductors](https://dx.doi.org/10.26434/chemrxiv-2025-713hw-v2?rft_dat=source%3Ddrss)  
Nicholas, Jackson; Vishnu, Raghuraman; Archana, Verma  
*Theoretical and Computational Chemistry on ChemRxiv*  
2025-07-28  
&ensp;The paper introduces an all-atom Reactive Monte Carlo Molecular Dynamics (RMCMD) method to assess molecular doping in organic semiconductors, using DFT-derived parameters. It calculates doping efficiency and radial distribution functions for a poly(3-hexylthiophene) system doped with a specific compound, with code available on GitHub. The method incorporates polaronic effects and charge transfer states.
...
Tobias Gulder, Elisabeth Strunk, Alfred Lobert, Tatiana Khorovich, Katia Guzman Lucio, Ren1 Richarz, Maximilian Hohmann, Paul D'Agostino  
*Biological and Medicinal Chemistry on ChemRxiv*  
2025-07-24  
&ensp;This paper investigates the biosynthesis of biphenomycins, potent antibiotics effective against Gram-positive pathogens. It identifies their ribosomal biosynthetic origins and characterizes enzymatic maturation steps, including selective ortho-hydroxylation and biaryl cross coupling. These insights support future antibiotic development strategies and the targeted discovery of novel compounds.  

- [A Small Molecule Substrate Mimic to Inhibit Bacterial Hsp70 Chaperone Function](https://dx.doi.org/10.26434/chemrxiv-2025-s53fd?rft_dat=source%3Ddrss)  
Ishu Saraogi, Tulsi Upadhyay, Reshma Kumari, Yogesh Gangarde, Upasana S Potteth, Rishij Roychowdhury, Anirban Das, Deepanshi Saxena, Rahul Maitra, Sidharth Chopra  
*Biological and Medicinal Chemistry on ChemRxiv*  
2025-07-24  
&ensp;This paper presents a small molecule inhibitor, a pyridylamide-based peptidomimetic, targeting bacterial Hsp70 (DnaK). This inhibitor disrupts protein homeostasis and chaperone function, resulting in impaired growth and biofilm formation in Gram-positive bacteria, providing a novel strategy against antibiotic resistance.  

- [Click-to-release for controlled immune cell activation: tumor-targeted unmasking of an IL12 prodrug](https://dx.doi.org/10.26434/chemrxiv-2025-fc7s1?rft_dat=source%3Ddrss)  
Marc Robillard, Martijn den Brok, Kim de Roode, Luc Zijlmans, Laurens Kleijn, Marleen van Stevendaal, Ron Versteegen, Lieke Wouters, Raffaella Rossin  
*Organic Chemistry on ChemRxiv*  
2025-07-24  
&ensp;This paper discusses a novel strategy for cancer immunotherapy using a click-to-release system that unmasked an IL12 prodrug to minimize toxicity. The IL12 prodrug is conjugated with PEG masks and activated via bioorthogonal click reactions, enabling controlled immune cell activation targeting tumors. Results demonstrate the potential of this approach in enhancing the therapeutic application of IL12.
...
*Organic Chemistry on ChemRxiv*  
2025-07-24  
&ensp;The paper presents a novel tumor-targeted therapy using a chemically masked IL12 prodrug, released via a bioorthogonal click reaction to minimize toxicity. Methods included in vitro masking tests, ELISA, and biodistribution studies in mice. Results showed efficient unmasking of IL12 specifically in tumors, demonstrating proof of principle for this click-to-release strategy.  

- [Boosting NAD+ for Anti-Aging: Mechanisms, Interventions, and Opportunities](https://dx.doi.org/10.26434/chemrxiv-2025-nl80r?rft_dat=source%3Ddrss)  
Faruk Alpay  
*Organic Chemistry on ChemRxiv*  
2025-07-24  
&ensp;The paper reviews over 60 studies on boosting NAD+ levels to combat aging. It identifies three main causes of NAD+ loss and evaluates various interventions, including vitamin B3 derivatives and lifestyle changes, showing that NAD+ repletion can rejuvenate functions and extend mouse lifespan by 10%. Early human trials suggest significant health benefits from supplementation. The review emphasizes a data-driven synergy of therapies for enhanced longevity.  

- [Remote Molecule Activation in Living Mice Triggered by Therapeutic Ultrasound](https://dx.doi.org/10.26434/chemrxiv-2025-sd6nk?rft_dat=source%3Ddrss)  
Xinyuan Fan, Shengnan Qin, Xuan Liang, Yufei Di, Ziqi Liu, Zhizheng Lou, Peng Chen  
*Organic Chemistry on ChemRxiv*  
2025-07-24  
&ensp;The paper presents a method called dBus, which uses therapeutic ultrasound to activate boronic acid molecules, converting them into hydroxyl groups. This technique allows precise control over various bioactive molecules in living mice, demonstrating significant tumor inhibition without side effects. Mechanistic studies reveal that hydroxyl radicals generated by ultrasound are responsible for this transformation, suggesting new applications in therapeutic interventions and diagnostics.  

- [Accurate Property Prediction of Fluorescent Dyes with KPGT-Fluor](https://dx.doi.org/10.26434/chemrxiv-2025-3lwn2?rft_dat=source%3Ddrss)  
Jiamin Zhong, Kui Du, Nan Zhou, Shaolong Lin, Li Qin, Dadong Shen, Jintian Lyu  
*Organic Chemistry on ChemRxiv*  
2025-07-24  
&ensp;The paper introduces KPGT-Fluor, an enhanced model for predicting fluorescent dye properties using a modified Knowledge-guided Pre-training of Graph Transformer framework. It incorporates solvent representations, achieving low Root Mean Square Errors (18.91 nm for absorption, 18.56 nm for emission). KPGT-Fluor outperforms existing methods and generalizes well across multiple datasets, demonstrating efficient prediction capabilities.  

- [ML/MM toolkit – Towards Accelerated Mechanistic Investigation of Enzymatic Reactions](https://dx.doi.org/10.26434/chemrxiv-2025-jft1k?rft_dat=source%3Ddrss)  
Takuto Ohmura, Sei Inoue, Tohru Terada  
*Theoretical and Computational Chemistry on ChemRxiv*  
2025-07-24  
&ensp;The ML/MM toolkit, an open-source resource developed for investigating enzymatic reaction mechanisms, integrates machine-learning interatomic potentials to reduce computational costs. It employs Meta's Universal Model for Atoms for tasks like energy minimization and transition-state searches, achieving accurate results in under two hours on a consumer GPU. Testing with a Claisen rearrangement showed activation barrier predictions within a few kcal mol−1 of experimental values.  

- [Combining Geometry and Topology for Accurate Protein Solubility Prediction](https://dx.doi.org/10.26434/chemrxiv-2025-jmzwn?rft_dat=source%3Ddrss)  
Sabari Kumar, Olivia Harman, Sumin Song, Yeonjoon Kim, Seonah Kim, Robert Paton  
*Theoretical and Computational Chemistry on ChemRxiv*  
2025-07-24  
&ensp;The paper introduces TopoFormer, a topological-geometric neural network for predicting protein solubility using 3D structural data from two datasets: 3DProtSolDB and 3DProtSolDB-Expt. The model achieves state-of-the-art predictive accuracy and offers insights into solvation behavior, correlating well with molecular dynamics simulations, aiding in designing soluble protein mutants.  

- [Diffusion and Deformation Mechanism Maps in Li Metal from Atomistic Simulations](https://dx.doi.org/10.26434/chemrxiv-2025-g0nbh?rft_dat=source%3Ddrss)  
Donald Siegel, Jeong Seop Yoon  
*Theoretical and Computational Chemistry on ChemRxiv*  
2025-07-24  
&ensp;The paper investigates Li transport mechanisms in lithium metal solid-state batteries using atomistic simulations. It predicts diffusion rates along dislocation cores and grain boundaries, and dominant creep mechanisms under varying conditions. The study shows that high dislocation densities can enhance battery performance for micron-sized Li grains. Key methods include molecular dynamics simulations and a 1D contact loss model.  

- [Solvent-Dependent Mechanism of Electrochemical Oxalate Oxidation](https://dx.doi.org/10.26434/chemrxiv-2025-2j4kq?rft_dat=source%3Ddrss)  
Joshua Beeler, Henry White, Mayank Tanwar, Jay Kitt, Joel Harris, Matthew Neurock  
*Theoretical and Computational Chemistry on ChemRxiv*  
2025-07-24  
&ensp;The paper explores the electrochemical oxidation of oxalate using H2O and DMF as solvents. Using cyclic voltammetry, finite difference simulations, Raman spectroscopy, and AIMD simulations, it reveals different oxidation waves and mechanisms in the two solvents. Key findings include new diffusion coefficients and predictions about C2O4•CO2 interactions affecting CO2 stability, with significant implications for thermodynamics in electrochemical processes.

## 20 May 2025  

- [HighMPNN: A Graph Neural Network Approach for Structure-Constrained Cyclic Peptide Sequence Design](https://dx.doi.org/10.26434/chemrxiv-2025-3pfd0?rft_dat=source%3Ddrss)  
Wen, Xu; Chengyun, Zhang; Tianfeng, Shang; Qingyi, Mao; Hongliang, Duan  
*Biological and Medicinal Chemistry on ChemRxiv*  
2025-05-19  
&ensp;The paper presents HighMPNN, a graph neural network for designing cyclic peptides that addresses limitations of existing models. It incorporates a structure prediction module and a dual-loss strategy combining cross-entropy with Frame Aligned Point Error (FAPE) loss. HighMPNN outperforms existing models in sequence recovery and structural consistency, facilitating the discovery of high-quality cyclic peptides for drug development.  

- [De novo design of inhibitors of histone deacetylase 8 for the treatment of schistosomiasis](https://dx.doi.org/10.26434/chemrxiv-2025-d2c8t?rft_dat=source%3Ddrss)  
Jos 19 L., Medina-Franco; Osvaldo, S 19nchez L 3a; Ana L., Ch 19vez-Hern 19ndez; Ver f3nica, Ram edrez-Cid  
*Biological and Medicinal Chemistry on ChemRxiv*  
2025-05-19  
&ensp;The paper outlines a study on the design of inhibitors targeting smHDAC8 for schistosomiasis treatment. Using LigBuilder V3, researchers created nine compound libraries with 2,355 molecules. After virtual screening, the top 40 candidates were selected based on docking scores and ligand efficiency. These compounds are available online for further validation as potential new treatments.  

- [Discovery, Optimization, and Anticancer Activity of Lipid-Competitive Pleckstrin Homology Domain-Containing Family A Inhibitors](https://dx.doi.org/10.26434/chemrxiv-2025-1hszr?rft_dat=source%3Ddrss)  
Jeremy M, Baskin; Nathan P, Frederick; Xiaofu, Cao; Yizhen, Jin; Andrew T, Lombardo  
*Biological and Medicinal Chemistry on ChemRxiv*  
2025-05-19  
&ensp;The paper discusses the discovery and optimization of inhibitors targeting pleckstrin homology (PH) domains in the PLEKHA family, identified through in silico screening and structure-activity relationship (SAR) optimization. The compounds show nanomolar to low micromolar binding affinity and induce cytotoxicity in melanoma and osteosarcoma cell lines with micromolar EC50 values, suggesting potential as anticancer agents.  

- [Activation of Orange Carotenoid Protein Requires a photoisomerization](https://dx.doi.org/10.26434/chemrxiv-2025-g2zn8?rft_dat=source%3Ddrss)  
Amanda, Arcidiacono; Mattia, Bondanza; Lorenzo, Cupellini; Benedetta, Mennucci  
*Biological and Medicinal Chemistry on ChemRxiv*  
2025-05-19  
&ensp;This paper investigates the activation mechanism of the orange carotenoid protein (OCP) through photoisomerization. The study demonstrates that the trans-to-cis photoisomerization of canthaxanthin is essential for carotenoid translocation. Transient absorption spectroscopy reveals that only the cis form exhibits necessary spectroscopic features, while multiphoton absorption aids in recovering all-trans canthaxanthin in OCPR.  

- [Dichalcogenide Fidaxomicin Derivatives to Probe Thiol-Mediated Uptake into Bacteria](https://dx.doi.org/10.26434/chemrxiv-2025-81f96?rft_dat=source%3Ddrss)  
Karl, Gademann; Anastassia, Kraimps; Tizian, Griesser; Rui, Wang; Silvia, Dittmann; Jordan, Costafrolaz; Erik, Jung; Patrick H. , Viollier; Susanne, Sievers; Peter, Sander  
*Biological and Medicinal Chemistry on ChemRxiv*  
2025-05-19  
&ensp;The paper investigates thiol-mediated uptake (TMU) of fidaxomicin (Fdx) derivatives to enhance delivery into bacteria. A library of dichalcogenide-modified Fdx was synthesized and tested against C. difficile and Mycobacterium tuberculosis, showing superior antibacterial activity. The study employed LC-MS/MS for quantifying intracellular accumulation in Mycobacterium bovis BCG, identifying stability and lipophilicity as key factors influencing efficacy.  

- [Evaluating SIRAH Force Field for Modeling Spontaneous and Redox-Responsive Peptide Self-Assembly](https://dx.doi.org/10.26434/chemrxiv-2025-1lthl-v2?rft_dat=source%3Ddrss)  
Yuanming, Song  
*Biological and Medicinal Chemistry on ChemRxiv*  
2025-05-19  
&ensp;The paper evaluates the SIRAH force field for simulating spontaneous and redox-responsive peptide self-assembly. Using experimentally characterized peptide sequences and comparisons to MARTINI simulations, the study finds SIRAH shows high aggregation tendencies and poor differentiation between aggregating and non-aggregating peptides. These limitations indicate a need for further parameter refinement to enhance its predictive capabilities for peptide-based systems.  

- [Accurate Structure Prediction of Natural Products with NatGen](https://dx.doi.org/10.26434/chemrxiv-2025-1v9j8?rft_dat=source%3Ddrss)  
jiazheng, xu; Qiaoyu, Hu; Changzhi, Sun; Shoude, Zhang; Xiaoli, Li; Honglin, Li; Weilie, Xiao; Xuhong , Qian; Changsheng, Zhang; Xuemin, Ding; Yichen, Liao; Wenchao, Tu; Youzhe, Chen; Xuewen , Wu; Wenjun , Zhang; Zihao , Shen; Yanyan , Mao; Kai , Zhang; Liang , He; Kaixian , Chen  
*Biological and Medicinal Chemistry on ChemRxiv*  
2025-05-19  
&ensp;This paper introduces NatGen, a deep learning framework for predicting the chiral configurations and 3D structures of natural products (NPs). It achieved 96.87% accuracy on a benchmark dataset and 100% in a study of 17 resolved NPs. NatGen predicted 684,619 NP structures from COCONUT, providing a valuable resource for researchers in various chemistry fields.  

- [Multi-Fidelity Learning for Atomistic Models via Trainable Data Embeddings](https://dx.doi.org/10.26434/chemrxiv-2025-vx7nx-v2?rft_dat=source%3Ddrss)  
Rick, Oerder; Gerrit, Schmieden; Jan, Hamaekers  
*Theoretical and Computational Chemistry on ChemRxiv*  
2025-05-19  
&ensp;This paper presents a multi-fidelity learning method for atomistic models using trainable data embeddings, addressing data inconsistencies from different DFT functionals. It employs a multi-task learning framework, allowing joint training on incompatible datasets. Experiments show improved transfer learning and data efficiency, achieving significantly lower errors compared to traditional methods.
...
*Biological and Medicinal Chemistry on ChemRxiv*  
2025-03-21  
&ensp;The paper presents a 3D-bioprinted fibroblast/DRG neuron co-culture scaffold to study peripheral nerve regeneration. The study optimized bioprinting parameters, achieving a biocompatible construct that supports cell growth. Results showed high viability of fibroblasts and enhanced neurite outgrowth in DRG neurons, emphasizing fibroblasts' role in axonal regeneration, and offering a platform for neuropathic pain therapies.  

- [AlphaFold2-RAVE: Protein Ensemble Generation with Physics-Based Sampling](https://dx.doi.org/10.26434/chemrxiv-2025-q3mwr-v2?rft_dat=source%3Ddrss)  
Da Teng, Vanessa J. Meraz, Akashnathan Aranganathan, Xinyu Gu, Pratyush Tiwary  
*Biological and Medicinal Chemistry on ChemRxiv*  
2025-03-21  
&ensp;The paper presents AlphaFold2-RAVE (af2rave), an open-source Python tool that combines machine learning and physics-based sampling to generate alternative protein conformations. It utilizes reduced MSA from AlphaFold2 and molecular dynamics simulations, validating on E. coli adenosine kinase and human DDR1 kinase. af2rave offers efficient sampling, outperforming traditional methods, making it a valuable resource for structural biology and drug discovery.  

- [Detecting apelin isoforms in human plasma using LC-MS/MS](https://dx.doi.org/10.26434/chemrxiv-2025-0c86q?rft_dat=source%3Ddrss)  
...
- [Toward Predictive Data-Driven Atomistic Modeling of Electrocatalyst Stability and Surface Reconstruction](https://dx.doi.org/10.26434/chemrxiv-2025-12mdb?rft_dat=source%3Ddrss)  
Jiayu Peng  
*Theoretical and Computational Chemistry on ChemRxiv*  
2025-03-21  
&ensp;The paper evaluates methods for modeling electrocatalyst stability and surface reconstruction, addressing challenges in understanding dissolution and restructuring. It examines classical and data-driven approaches, including first-principles simulations and machine learning techniques, highlighting their strengths and weaknesses. The findings aim to enhance predictive modeling for optimizing electrocatalysts under harsh conditions.  

- [CoRE MOF DB: a curated experimental metal-organic framework database with machine-learned properties for integrated material-process screening](https://dx.doi.org/10.26434/chemrxiv-2024-nvmnr-v2?rft_dat=source%3Ddrss)  
...
- [Electrochemical Oxidation of Benzyl Alcohols via Hydrogen Atom Transfer Mediated by 2,2,2-Trifluoroethanol](https://dx.doi.org/10.26434/chemrxiv-2025-zw2n4?rft_dat=source%3Ddrss)  
...
- [Molecularly defined glycocalyx models reveal AB5 toxins recognize their target glycans superselectively](https://dx.doi.org/10.26434/chemrxiv-2025-bf93l?rft_dat=source%3Ddrss)  
...
*Organic Chemistry on ChemRxiv*  
2025-03-19  
&ensp;The paper introduces the Alexandria Chemistry Toolkit (ACT), an open-source software for machine learning physics-based force fields (FFs) using customizable potential functions. It employs a genetic algorithm and Monte-Carlo methods to optimize FF parameters. The evaluation of different models demonstrates improved prediction accuracy for organic molecules' properties in gas and liquid phases.  
- [MASSISTANT: A Deep Learning Model for De Novo Molecular Structure Prediction from EI-MS Spectra via SELFIES Encoding](https://dx.doi.org/10.26434/chemrxiv-2025-qchjl?rft_dat=source%3Ddrss)  
Marcin Pietrasik, John Mommers, Lazar Barta, Anna Wilbik  
*Theoretical and Computational Chemistry on ChemRxiv*  
2025-03-19  
&ensp;The paper presents MASSISTANT, a deep learning model for predicting molecular structures from low-resolution EI-MS spectra using SELFIES encoding. Using the NIST dataset with 180k spectra, MASSISTANT achieves about 10% exact predictions, improving to 54% with a curated dataset. The model enhances the interpretation of chromatographic peaks in mass spectrometry, leveraging complex fragmentation patterns to generate valid chemical structures.  
- [Data-driven discovery of water-stable metal-organic frameworks with high water uptake capacity](https://dx.doi.org/10.26434/chemrxiv-2025-mz223?rft_dat=source%3Ddrss)  
Akash Ball, Gianmarco Terrones, Shuwen Yue, Heather Kulik  
*Theoretical and Computational Chemistry on ChemRxiv*  
2025-03-19  
&ensp;The paper presents a machine learning and high-throughput screening approach to discover water-stable metal-organic frameworks (MOFs) with high water uptake capacity. Utilizing 736 curated MOFs and grand canonical Monte Carlo simulations, the study identifies strong correlations between pore features and water uptake. Ultimately, 74 promising MOFs are predicted to exhibit both water stability and high capacity.  
- [3D2SMILES: Translating Physical Molecular Models into Digital DeepSMILES Notations Using Deep Learning](https://dx.doi.org/10.26434/chemrxiv-2024-zvcb4-v4?rft_dat=source%3Ddrss)  
Wenqi Guo, Yiyang Du, Mohamed Shehata  
*Theoretical and Computational Chemistry on ChemRxiv*  
2025-03-19  
&ensp;The paper presents 3D2SMILES, a deep learning model that converts images of physical molecular models into digital DeepSMILES notations. Utilizing both synthetic and real datasets, it achieved 62.0% top-1 and 80.3% top-3 accuracy. The study also addresses model explainability, limitations, and future research directions.
